...
import { GeneratePage } from '@imagenes/pages/GeneratePage';
import { HomePage } from '@imagenes/pages/HomePage';
...
interface ImagenesGameProps {
  /** Vuelve siempre a la pantalla principal (launcher). */
  onExit: () => void;
}

export default function ImagenesGame({ onExit }: ImagenesGameProps) {
